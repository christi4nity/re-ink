...
interface ReadLaterDao {
    ...
    @Query("UPDATE read_later SET fetchStatus = :status, title = :title, contentHtml = :contentHtml WHERE id = :id")
    suspend fun updateContent(id: Long, status: String, title: String, contentHtml: String)
